...
export class Trabajo {
  ...
  static async getAll() {
    ...
    return trabajos.map(({ id, nombre, definicion, uf, ra, fecha_inicio, fecha_final, modulo }) => {
      return new Trabajo(id, nombre, definicion, uf, ra, fecha_inicio, fecha_final, modulo)
    })
  }
